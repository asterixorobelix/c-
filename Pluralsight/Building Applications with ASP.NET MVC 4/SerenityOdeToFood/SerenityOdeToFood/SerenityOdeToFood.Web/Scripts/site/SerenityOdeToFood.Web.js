...
(function (SerenityOdeToFood) {
    ...
    })(Administration = SerenityOdeToFood.Administration || (SerenityOdeToFood.Administration = {}));
...
(function (SerenityOdeToFood) {
    ...
    })(Membership = SerenityOdeToFood.Membership || (SerenityOdeToFood.Membership = {}));
})(SerenityOdeToFood || (SerenityOdeToFood = {}));
var SerenityOdeToFood;
(function (SerenityOdeToFood) {
    var Membership;
...
(function (SerenityOdeToFood) {
    ...
    })(Authorization = SerenityOdeToFood.Authorization || (SerenityOdeToFood.Authorization = {}));
})(SerenityOdeToFood || (SerenityOdeToFood = {}));
var SerenityOdeToFood;
(function (SerenityOdeToFood) {
    var Administration;
...
(function (SerenityOdeToFood) {
    ...
    SerenityOdeToFood.BasicProgressDialog = BasicProgressDialog;
})(SerenityOdeToFood || (SerenityOdeToFood = {}));
var SerenityOdeToFood;
(function (SerenityOdeToFood) {
    var Common;
    (function (Common) {
        var BulkServiceAction = (function () {
            ...
            BulkServiceAction.prototype.createProgressDialog = function () {
                this.progressDialog = new SerenityOdeToFood.BasicProgressDialog();
...
(function (SerenityOdeToFood) {
    ...
    })(DialogUtils = SerenityOdeToFood.DialogUtils || (SerenityOdeToFood.DialogUtils = {}));
})(SerenityOdeToFood || (SerenityOdeToFood = {}));
var SerenityOdeToFood;
(function (SerenityOdeToFood) {
    var Common;
...
(function (SerenityOdeToFood) {
    ...
    (function (LanguageList) {
        function getValue() {
            var result = [];
            for (var _i = 0, _a = SerenityOdeToFood.Administration.LanguageRow.getLookup().items; _i < _a.length; _i++) {
                var k = _a[_i];
                if (k.LanguageId !== 'en') {
    ...
    })(LanguageList = SerenityOdeToFood.LanguageList || (SerenityOdeToFood.LanguageList = {}));
})(SerenityOdeToFood || (SerenityOdeToFood = {}));
var SerenityOdeToFood;
(function (SerenityOdeToFood) {
    var Common;
...
(function (SerenityOdeToFood) {
    ...
    (function (ScriptInitialization) {
        ...
        Serenity.EntityDialog.defaultLanguageList = SerenityOdeToFood.LanguageList.getValue;
    })(ScriptInitialization = SerenityOdeToFood.ScriptInitialization || (SerenityOdeToFood.ScriptInitialization = {}));
})(SerenityOdeToFood || (SerenityOdeToFood = {}));
var SerenityOdeToFood;
(function (SerenityOdeToFood) {
    var Common;
...
//# sourceMappingURL=SerenityOdeToFood.Web.js.map